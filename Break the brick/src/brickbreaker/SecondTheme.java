...
public class SecondTheme extends JPanel implements KeyListener, ActionListener{
	// declaring images :D
    Image paddle;
	Image football;
	...
	public SecondTheme() {
		...
		try {
			football = ImageIO.read(getClass().getResource("/images/beach-ball.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		
		map = new SecondGen(4,8,0,0);
		addKeyListener(this);
		setFocusable(true);
